...
<html>
  <head>
    ...
    <title>Create Footer | VSAP & Company</title>
  ...
  <section class="content">
    ...
    @endif
     <form method="post" action="/storefooter" role="form" enctype="multipart/form-data">
       {{ csrf_field() }}
      <div class="box-body">

      <div class="form-group">
        <label>Services</label>
          <textarea class="form-control" rows="5" name="services" placeholder="Enter Services" style="resize:none" required></textarea>
      </div>
      ...
      <div class="form-group">
        ...
        <input type="tel" class="form-control" name="office_no" placeholder="Enter Office No" required>
      </div>
