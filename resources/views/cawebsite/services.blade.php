...
<head>
  ...
  .asked-area{margin-bottom: -35px;}
  .services1{padding-right: 5px;}
  ...
  <div class="container">
    <div class="row">
     ...
     <div class="accordion" id="accordionExample">  
      ...
      <h4 class="card-title" >
      <a  class="collapsed "  data-toggle="collapse" aria-expanded="true" href="#one" aria-controls="one" >
...
<div class="card">
  ...
  <div class="col-lg-6 services1">
      <div class="card">

      <div class="card-header" role="tab" id="headingSix">
      <h4 class="card-title" style="margin-top: 0px;margin-bottom: 20px " >
      <a class="collapsed" data-toggle="collapse" aria-expanded="false" href="#six" aria-controls="six">
     ...
     <div id="six" class="collapse" role="tabpanel" aria-labelledby="headingSix" data-parent="#accordionExample">
      ...
      <ul class="list">Financial products –
        <li>Term Loan</li>
    ...
    <div class="card-header" role="tab" id="headingSeven">
      ...
      <a class="collapsed" data-toggle="collapse" aria-expanded="false" href="#seven" aria-controls="seven">
   ...
   <div class="card-header" role="tab" id="headingEight">
    <h4 class="card-title" style="margin-bottom: 20px">
      <a class="collapsed" data-toggle="collapse" aria-expanded="false" href="#eight" aria-controls="eight">
...
<div class="card">
   <div class="card-header" role="tab" id="headingNine">
    <h4 class="card-title" style="margin-bottom: 20px">
      <a class="collapsed" data-toggle="collapse" aria-expanded="false" href="#nine" aria-controls="nine">
...
<div class="card">
   <div class="card-header" role="tab" id="headingTen">
    <h4 class="card-title" style="margin-bottom: 20px">
      <a class="collapsed" data-toggle="collapse" aria-expanded="false" href="#ten" aria-controls="ten">
...
<ul class="list">Our services includes -
 ...
 <li>Updation of details with RERA Authority website</li>
