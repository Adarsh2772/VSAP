   ...
   <div class="bg-light fix" style="margin-top: 30px" >
    ...
    <div class="information-text" >
      <div class="container" style="margin-top: 20px">
        ...
        <h5 class="vaibhav" style="color:#053b5adb;text-align: center;margin-top: 10px">Mr. Vaibhav R Mayur</h5>
          <div style="text-align: center;">
          <span style="color:#185a8a;">FCA, M.com, DISA</span>
          </div>
         </div>
    ...
    <div class="information-text" >
      <div class="container" style="margin-top: 20px">
        <div class="about-text">
        <h5 style="color:#053b5adb;text-align: center;margin-top: 10px">Mr. Sachin B Malpani</h5>
          <div style="text-align: center;">
          <span style="color:#185a8a;">FCA, B.com</span>
          </div>
         </div>
         <span class="col-md-12">
            <p align="left" class="col-md-6">
    ...
    <div class="information-text">
      <div class="container" >
        <div class="about-text">
        <h5 style="color:#053b5adb;text-align: center;margin-top: 10px">Mr. Akshay G Bihani</h5>
          <div style="text-align: center;">
          <span style="color:#185a8a;">FCA, B.com</span>
          </div>
         </div>
    ...
    <div class="information-text">
      <div class="container" style="margin-top: 20px">
        <div class="about-text">
        <h5 style="color:#053b5adb;text-align: center;margin-top: 10px">Mr.CA Swapnil R. Rathi</h5>
          <div style="text-align: center;">
          <span style="color:#185a8a;">FCA, B.com</span>
          </div>
         </div>
    ...
    <div class="information-text">
      <div class="container" >
        <div class="about-text">
        <h5 style="color:#053b5adb;text-align: center;margin-top: 10px">CA Aakansha Jain</h5>
          <div style="text-align: center;">
          <span style="color:#185a8a;">ACA, B.com</span>
          </div>
         </div>
