...
<html>
  <head>
    ...
    <title>Create Client | VSAP & Company</title>
  ...
  <section class="content">
    ...
    @endif
     <form method="post" action="/storeclient" role="form" enctype="multipart/form-data">
       {{ csrf_field() }}
      <div class="box-body">
      ...
      <div class="form-group">
        ...
        <input type="file" class="form-control" name="client_img" placeholder="Choose image" required>
      </div>
