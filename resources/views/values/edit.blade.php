...
<html>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>Update Our Value</h1>
       <ol class="breadcrumb">
        <li><a href="/values"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Update Our Value</li>
      </ol>
    </section>
  ...
  <section class="content">
    ...
    @endif
     <form method="post" action="/updatevalue" role="form" enctype="multipart/form-data">
       {{ csrf_field() }}
      <div class="box-body">
      ...
      <div class="form-group">
        <label>Description</label>
          <textarea class="form-control" rows="3" name="descript">{{ $value->descript }}</textarea>
      </div>
      </div><!-- /.box-body -->
